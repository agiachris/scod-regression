from typing import Optional, Union, Callable, Tuple, List, Type
...
def flatten(x: Union[Tuple[torch.Tensor, ...], List[torch.Tensor]]) -> List[torch.Tensor]:
...
def map_structure(
    func: Callable, *args, atom_type: Union[Type, Tuple[Type, ...]] = (torch.Tensor, np.ndarray)
):
